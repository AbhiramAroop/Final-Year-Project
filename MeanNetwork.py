...
input_data_sets = preprocessing.get_mean_data()
output_data_sets = preprocessing.get_output_list()
...
x = np.array(input_data_sets[0:3900]).reshape(3900,41)
...
y = np.array(output_data_sets[0:3900])
print(len(y))

#print(x)
#print(y)
#z = np.array(x[0])
z = np.array(input_data_sets[3900:3977]).reshape(77,41)
z_output = []
for i in range(len(z)):
    z_output.append(output_data_sets[i+3900])
    #sample test dataset
...
training = model2.fit(x=x, y=y, batch_size=64, epochs=41, shuffle=True, verbose=1, validation_split=0.1)
...
explainer_shap(model2,
               X_names=["1st: " + str(round(x[i][0],2)),
                        ...
                        "11st: " + str(round(x[i][10],2)),
                        "12nd: " + str(round(x[i][11],2)),
                        "13rd: " + str(round(x[i][12],2)),
                        "14th: " + str(round(x[i][13],2)),
                        "15th: " + str(round(x[i][14],2)),
                        "16th: " + str(round(x[i][15],2)),
                        "17th: " + str(round(x[i][16],2)),
                        "18th: " + str(round(x[i][17],2)),
                        "19th: " + str(round(x[i][18],2)),
                        "20th: " + str(round(x[i][19],2)),
                        "21st: " + str(round(x[i][20],2)),
                        "22nd: " + str(round(x[i][21],2)),
                        "23rd: " + str(round(x[i][22],2)),
                        "24th: " + str(round(x[i][23],2)),
                        "25th: " + str(round(x[i][24],2)),
                        "26th: " + str(round(x[i][25],2)),
                        "27th: " + str(round(x[i][26],2)),
                        "28th: " + str(round(x[i][27],2)),
                        "29th: " + str(round(x[i][28],2)),
                        "30th: " + str(round(x[i][29],2)),
                        "31st: " + str(round(x[i][30],2)),
                        "32nd: " + str(round(x[i][31],2)),
                        "33rd: " + str(round(x[i][32],2)),
                        "34th: " + str(round(x[i][33],2)),
                        "35th: " + str(round(x[i][34],2)),
                        "36th: " + str(round(x[i][35],2)),
                        "37th: " + str(round(x[i][36],2)),
                        "38th: " + str(round(x[i][37],2)),
                        "39th: " + str(round(x[i][38],2)),
                        "40th: " + str(round(x[i][39],2)),
                        "41th: " + str(round(x[i][40], 2))],
